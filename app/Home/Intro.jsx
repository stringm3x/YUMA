...
const Intro = () => {
  return (
    <section className="flex flex-col gap-20 py-20">
      ...
      <div className="flex flex-wrap gap-10 xl:gap-2 justify-around">
        {cards.map((item) => (
          <Link key={item.id} href={item.link}>
            <div className="relative group w-64 h-80 p-5 bg-white content-center justify-items-center rounded-2xl overflow-hidden">
